...
public class Challenges {
	...
	/*
	 * This is my code for the API Challenge, I wrote it in Java since it is my strongest language.
	 * I have never before worked with an API before so this was my first time! I did use google to 
	 * further my knowledge about API's work and to get me through some kinks here and there. I have really
	 * learned a ton through this challenge and enjoyed it all the way through. Thanks a lot!
	 */
	...
	/**
	  * This method performs the reversal of a string and send the
	  * reversed string back to the API endpoint for validation.
	  * @param Nothing.
	  * @return Nothing.
